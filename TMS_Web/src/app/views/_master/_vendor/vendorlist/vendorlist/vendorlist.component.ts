...
export class VendorlistComponent implements OnInit {
  ...
  loadCustomerToEdit(vendorkey: string) {
    this.Service.getDriverById(vendorkey).subscribe(_updateVendor => {
  ...
  CreateVendor() {
    if (this.updateVendor == null) {
      this.Service.createDriver(this.dataModel).subscribe(() => {
        this.dataSaved = true;
      ...
      this.Service.updateDriver(this.dataModel).subscribe(() => {
        this.dataSaved = true;
